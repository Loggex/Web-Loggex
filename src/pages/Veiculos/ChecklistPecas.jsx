...
export default function Checklist() {
    ...
    async function BuscarPecas() {
        ...
        await axios('http://deploy-loggex-backend.azurewebsites.net/api/pecas/checklist/' + placa, {
            headers: {
                                            ...
                                            <Modal.Body>
                                                <div className='containerModal'>
                                                    <div className='boxImg'>
                                                        <p>Imagem original</p>
                                                        <img src={"http://deploy-loggex-backend.azurewebsites.net/StaticFiles/Images/" + imPecaC} alt="" />
                                                    </div>
                                                    <div className='boxImg'>
                                                        <p>Imagem atual</p>
                                                        <img src={"http://deploy-loggex-backend.azurewebsites.net/StaticFiles/Images/" + imgPeca} alt="" />
                                                    </div>
                                                </div>
                                            </Modal.Body>
                                            <Modal.Footer>
